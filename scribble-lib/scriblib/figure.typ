...
#let Herefigure(body) = block(width: 100%, align(center, body))

#let Centerfigure(body) = block(width: 100%, align(center, body))
#let Leftfigure(body) = block(width: 100%, align(left, body))
#let Rightfigure(body) = block(width: 100%, align(right, body))
...
#let FigureRef(body) = body
#let FigureTarget(body) = body
